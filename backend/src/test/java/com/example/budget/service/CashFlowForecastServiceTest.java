...
class CashFlowForecastServiceTest {
    ...
    void forecastAppliesEveryFutureTransactionInItsPaymentMonth() {
        ...
        // The expense estimate (plan or historical average) never applies to the
        // current month, so this month's net cash flow is unaffected by it.
        ...
        // spend (1 basis month) is applied as the estimate for this future month.
        assertThat(nextMonth.projectedClosingBalance()).isEqualByComparingTo("1600.00");
    }
