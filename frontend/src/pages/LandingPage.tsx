...
export default function LandingPage({ onGetStarted }: { onGetStarted: () => void }) {
  ...
  const heroSectionGradient = useColorModeValue(
    'linear(to-br, blue.50, purple.50, pink.50)',
  ...
  const heroTitleColor = useColorModeValue('gray.700', 'gray.200')
  const heroSubtitleColor = useColorModeValue('gray.600', 'gray.300')
  const cardBorderColor = useColorModeValue('gray.200', 'gray.700')
  const benefitIconBg = useColorModeValue('blue.50', 'blue.900')
  const faqHoverBg = useColorModeValue('gray.50', 'gray.700')
  ...
  return (
    <Box as="main" minH="100vh" bgGradient={bgGradient} display="flex" flexDirection="column">
      {/* Header */}
      ...
      <Box
        ...
        position="relative"
        overflow="hidden"
        bgGradient={heroSectionGradient}
      >
          ...
          <VStack spacing={{ base: 6, sm: 8 }} textAlign="center">
            ...
            <VStack spacing={4} w={{ base: "full", sm: "auto" }}>
              <MotionButton
                ...
                aria-label="Start using Personal Budget for free"
      ...
      <Box id="how-it-works" py={{ base: 12, sm: 16, md: 20 }} bg={cardBg}>
        <Container maxW={{ base: "100%", xl: "1400px", "2xl": "1600px" }} px={{ base: 4, md: 8, lg: 12, xl: 16 }}>
          <VStack spacing={{ base: 12, sm: 16 }}>
            <MotionBox
              initial={{ opacity: 0, y: 20 }}
            ...
            <MotionButton
              ...
              rightIcon={<ArrowForwardIcon />}
              onClick={onGetStarted}
              aria-label="Start your Personal Budget journey"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              px={10}
              py={7}
      ...
      {/* FAQ Section */}
      <Box id="faq" py={{ base: 12, sm: 16, md: 20 }} bg={cardBg}>
            ...
            <VStack spacing={{ base: 6, sm: 8 }}>
              ...
              <VStack spacing={4} pt={4}>
                <MotionButton
                  size="lg"
                  onClick={onGetStarted}
                  aria-label="Start free now with Personal Budget"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  px={{ base: 10, md: 12 }}
                  py={{ base: 7, md: 8 }}
